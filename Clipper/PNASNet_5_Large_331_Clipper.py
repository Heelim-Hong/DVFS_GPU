...
# tf.compat.v1.loggint.set_verbosity(tf.compat.v1.logging.INFO)
...
def getResnet50():
  with gfile.FastGFile("/home/heelim/BatchDVFS/Clipper/FrozenGraphs/frozen_pnasnet_large.pb",'rb') as f:
